...
export const ListOfProductsCollectsNowQuantity: FC = () => {
    ...
    const {getListOfProductsCollectsNowQuantity} = useProceduresFunctions();
    useEffect(()=>{
        dispatch(getListOfProductsCollectsNowQuantity({CompanyId: 1, ManufactoryId: 1, AreaId: 1}));
    },[dispatch, getListOfProductsCollectsNowQuantity]);
    ...
    return (
        <>
        <Body>
            <Title>LIST OF PRODUCTS COLLECTS NOW QUANTITY MENU</Title>
            <List>
        ...
        <Body isDWidth={true}>
            <Title>LIST OF PRODUCTS COLLECTS NOW QUANTITY TABLE</Title>
            <Table data={data}/>
        </Body>
        </>
    );
