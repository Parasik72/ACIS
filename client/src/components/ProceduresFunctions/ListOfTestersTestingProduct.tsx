...
export const ListOfTestersTestingProduct: FC = () => {
    ...
    const {getListOfTestersTestingProduct} = useProceduresFunctions();
    const formatYmd = (date: Date) => date.toISOString().slice(0, 10);
    useEffect(()=>{
        dispatch(getListOfTestersTestingProduct({ProductName: 'Boeing / Sikorsky RAH-66 Comanche', DateFrom: '2002-01-01', DateTo: '2022-01-01'}));
    },[dispatch, getListOfTestersTestingProduct]);
